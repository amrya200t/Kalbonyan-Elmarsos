...
<br />
## JavaScript
- [x]  `Done` `69h` - 12 - [The Complete JavaScript Course 2022: From Zero to Expert!](./02-Udemy/-02-Js-Jonas)
## ReactJs
- [x]  `in progress` `48h` - 13 - [React - The Complete Guide (incl Hooks, React Router, Redux)](./02-Udemy/-03-Reactjs-Maximilian)
## NodeJs
- [x]  `in progress` `46h` - 14 - [Complete NodeJS Developer in 2022 (GraphQL, MongoDB, + more)](./02-Udemy/-04-Nodejs-ZTM)
...
![100%](https://progress-bar.dev/100/?title=Done)
- [x]  `in progress` `16h` - 15 - [AWS Certified Cloud Practitioner (CLF-C01)](03-aCloudGuru/AWS%20Certified%20Cloud%20Practitioner%20(CLF-C01)/)
- [x]  `in progress` `42h` - 16 - [AWS Certified Solutions Architect Associate (SAA-C02)](03-aCloudGuru/AWS%20Certified%20Solutions%20Architect%20Associate%20(SAA-C02))
...
![100%](https://progress-bar.dev/100/?title=Done)
- [x] `in progress` - 17 - [Serverless Stack (SST)](04-Serverless-Stack-Project/)
